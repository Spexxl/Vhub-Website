...
export default function Footer() {
    ...
    return (
        <div className="w-full h-screen relative z-50 bg-white flex flex-col justify-between items-center px-10">
            <div className="flex item justify-between w-full pt-10">
                <div className="flex flex-col justify-center items-start gap-4">
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px]">
                        <motion.h4
                            ...
                            className="font-light text-9xl text-foreground">
                            Clique
                        </motion.h4>
                    </div>
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px]">
                        <motion.h4
                            ...
                            className="font-medium text-9xl text-foreground">
                            Baixe
                        </motion.h4>
                    </div>
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px]">
                        <motion.h4
                            ...
                            className="font-extrabold text-9xl text-foreground">
                            Evolua.
                        </motion.h4>
                    </div>
                </div>
                <div className="text-2xl text-foreground flex flex-col justify-center items-center gap-4">
                    ...
                    <div className="flex gap-6 justify-center items-center">
                        <div className="flex items-center justify-center w-[320px] h-[220px] rounded-2xl border-[2px] border-[#22242750]">
            ...
            <div className="w-full flex flex-col gap-20">
                ...
                <div className="pt-10 pb-8 flex items-center justify-between w-full text-base border-t-[1px] border-[#22242725]">
