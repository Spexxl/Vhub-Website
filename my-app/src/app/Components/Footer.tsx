...
export default function Footer() {
    ...
    return (
        <div className="w-full h-screen relative z-50 bg-[#222427] flex flex-col justify-between items-center px-10
        max-[980px]:gap-28 max-[980px]:h-auto max-[980px]:px-5">
                ...
                <div className="flex flex-col justify-center items-start gap-4">
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px]">
                        <motion.h4
                            ...
                            className="font-light text-9xl text-white max-[600px]:text-[22vw]">
                            Clique
                        </motion.h4>
                    </div>
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px] max-[600px]:mt-[-3vw] max-[460px]:mt-[-7vw]">
                        <motion.h4
                            ...
                            className="font-medium text-9xl text-white max-[600px]:text-[22vw]">
                            Baixe
                        </motion.h4>
                    </div>
                    <div ref={ref} className="overflow-hidden relative flex items-center h-[120px] max-[600px]:mt-[-3vw] max-[460px]:mt-[-7vw]">
                        <motion.h4
                            ...
                            className="font-extrabold text-9xl text-white max-[600px]:text-[22vw]">
                            Evolua.
                        </motion.h4>
                    </div>
                </div>
                <div className="text-2xl text-white flex flex-col justify-center items-center gap-4 max-[600px]:w-full">
                    ...
                    <div className="flex gap-6 justify-center items-center max-[600px]:w-full max-[600px]:gap-0 max-[600px]:justify-between">
                        <div className="flex items-center justify-center w-[320px] h-[220px] rounded-xl border-[2px] border-white
                        max-[1240px]:w-[22vw] max-[980px]:w-[260px] max-[600px]:w-[43vw] max-[600px]:h-[40vw]">
                            ...
                            className="max-[1240px]:h-[8vw] max-[980px]:h-full max-[600px]:w-[28vw]">
                                <path fillRule="evenodd" clipRule="evenodd" d="M63.353 1.0649C62.771 1.6809 62.429 2.6349 62.429 3.8729V48.0689C62.429 49.3069 62.771 50.2609 63.353 50.8769L63.501 51.0209L88.259 26.2629V25.6789L63.501 0.920898L63.353 1.0649Z" fill="#ffffff" />
                                ...
                                <g mask="url(#mask0_0_1)">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M96.509 34.5188L88.259 26.2628V25.6788L96.513 17.4248L106.477 23.0848C109.269 24.6728 109.269 27.2688 106.477 28.8548L96.699 34.4108L96.509 34.5188Z" fill="#ffffff" fillOpacity="0.8" />
                                </g>
                                ...
                                <g mask="url(#mask1_0_1)">
                                    <path fillRule="evenodd" clipRule="evenodd" d="M96.699 34.4107L88.259 25.9707L63.353 50.8767C64.275 51.8507 65.795 51.9707 67.507 50.9987L96.699 34.4107Z" fill="#ffffff" fillOpacity="0.8" />
                                </g>
            ...
            <div className="w-full flex flex-col gap-20">
                <nav className="flex justify-between items-start w-full max-[980px]:flex-wrap max-[980px]:justify-start max-[980px]:gap-14">
                    ...
                    <div className="flex flex-col items-end justify-center gap-8 max-[980px]:items-start">
                        <span className="text-base text-white opacity-80">
                            (Razão Social)
                        </span>
                        <div className="text-base text-white text-end max-w-[300px] max-[980px]:text-start">
                            <p>JEAN LUCAS DE CAMILLO TECNOLOGIA DA INFORMAÇÃO LTDA</p>
                        </div>
                    </div>
                </nav>
                <div className="pt-10 pb-8 flex items-center justify-between w-full text-base text-white border-t-[1px] border-[#ffffff50]  max-[600px]:flex-col
                max-[600px]:justify-start max-[600px]:items-start max-[600px]:gap-4">
                    <p>© Vibrant Hub 2025</p>
                    <a href="/politicas-de-privacidade" className="underline text-white">Politicas De Privacidade</a>
                    <p className=" text-white">contato@vibranthub.com.br</p>
                </div>
            </div>
        </div>
    )
